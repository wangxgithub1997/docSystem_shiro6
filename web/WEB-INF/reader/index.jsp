                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li role="presentation" class="divider"></li>
                                <li><a href="${pageContext.request.contextPath}/reader/readerLoginController_logout.action">退出</a>
                                </li>
                            </ul>
                        </li>
                        </c:if>
    ...
    <div class="row">
        ...
        <div class="col-md-2 bootstrap-admin-col-left">
            <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
                ...
                <c:if test="${sessionScope.reader != null }"><!-- 判断是否登录 -->
                <li>
                    <a href="${pageContext.request.contextPath}/reader/overdueAction_findMyForfeitInfoByPage.action"><i
