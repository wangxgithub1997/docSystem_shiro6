function setPower() {
    ...
    if (power.length == 0) {
        ...
        $.post("/admin/authorizationController_addAuthorization.action", postData, function (data) {
            if (data == 1) {
...
function power(id) {
    $.post("/admin/authorizationController_getAuthorization.action", "id=" + id, function (data) {
        $("#aid").val(data.id);
