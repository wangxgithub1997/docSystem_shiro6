$(function () {
    $("#addType").blur(function () {
        ...
        $.post("/admin/readerTypeManageController_getReaderTypeByName.action", postData, function (data) {
            if (data == 1) {
    ...
    $("#addReaderType").click(function () {
        ...
        var postData = "name=" + $.trim($("#addType").val())
            + "&maxNum=" + $.trim($("#addMaxNum").val())
            + "&bday=" + $.trim($("#addBday").val())
            + "&penalty=" + $.trim($("#addPenalty").val())
            + "&renewDays=" + $.trim($("#addrenewDays").val());
        $.post("/admin/readerTypeManageController_addReaderType.action", postData, function (data) {
            if (data == 1) {
