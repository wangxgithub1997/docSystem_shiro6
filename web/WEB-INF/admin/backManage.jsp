                ...
                <div class="col-lg-12">
                    ...
                    <script type="text/javascript">
                        function page(pageCode) {
                            window.location.href = "${pageContext.request.contextPath}/admin/backManageController_list.action?pageCode=" + pageCode
                            +"&ISBN=${query.ISBN}&borrowId=${query.borrowId}&paperNO=${query.paperNO}";
                        }
                    </script>
