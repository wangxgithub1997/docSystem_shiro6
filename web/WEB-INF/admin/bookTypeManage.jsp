                ...
                <div class="col-lg-12">
                            ...
                            <c:when test="${pb.list != null}">
                                <c:forEach items="${pb.list}" var="b">
                                    <tr>
                                        <td>${b.name}</td>
                                        <td>
                                            <button class="btn btn-warning btn-xs" onclick="getBookTypeById(${b.id})" >修改</button>
                    ...
                    <script type="text/javascript">
                        function page(pageCode) {
                            window.location.href = "${pageContext.request.contextPath}/admin/bookTypeManageController_list.action?pageCode="
