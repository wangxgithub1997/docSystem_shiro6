                ...
                <div class="col-lg-12">
                    ...
                    <script type="text/javascript">
                        function page(pageCode) {
                            window.location.href = "${pageContext.request.contextPath}/admin/overDueManageController_list.action?pageCode=" + pageCode
                            +"&paperNO=${query.paperNO}&borrowId=${query.borrowId}&ISBN=${query.ISBN}";
                        }
                    </script>
