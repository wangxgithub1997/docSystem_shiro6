...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/getBackInfo.js"></script>
                ...
                <div class="col-lg-12">
                    ...
                    <script type="text/javascript">
                        function page(pageCode) {
                            window.location.href = "${pageContext.request.contextPath}/admin/borrowSearchController_list.action?pageCode=" + pageCode
                            +"&borrowId=${query.borrowId}&ISBN=${query.ISBN}&paperNO=${query.paperNO}";
                        }
                    </script>
