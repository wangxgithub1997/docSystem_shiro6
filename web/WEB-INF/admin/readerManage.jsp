...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/admin/readermanager/getReader.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/static/js/admin/readermanager/updateReader.js"></script>

    <script src="${pageContext.request.contextPath}/static/js/admin/readermanager/addReader.js"></script>


    <script src="${pageContext.request.contextPath}/static/js/admin/readermanager/getAllReaderTypes.js"></script>

    <script src="${pageContext.request.contextPath}/static/js/admin/readermanager/batchAddReader.js"></script>
    <script src="${pageContext.request.contextPath}/static/js/admin/readermanager/exportReader.js"></script>
    ...
    <script type="text/javascript">
        //js 获取域中的值
        var readerType = "${query.readerType}";
    </script>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li role="presentation" class="divider"></li>
                                <li><a href="${pageContext.request.contextPath}/admin/adminLoginController_logout.action">退出</a>
                                </li>
                            </ul>
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal"
                                ...
                                <div class="col-lg-5 form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id="readerId" type="text" value="${query.paperNO}" name="paperNO">
                                ...
                                <div class="col-lg-5 form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id="readerName" name="name" type="text" value="${query.name}">
                ...
                <div class="col-lg-12">
                    ...
                    <script type="text/javascript">
                        function page(pageCode) {
                            window.location.href = "${pageContext.request.contextPath}/admin/readerManageController_list.action?pageCode=" + pageCode+
                            "&paperNO=${query.paperNO}&name=${query.name}&readerType=${query.readerType}";
                        }
                    </script>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/admin/fileUploadController_fileUpload.action" id="uploadForm" method="post" enctype="multipart/form-data">
                                <!---------------------表单-------------------->
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">下载模板</label>
                                    <div class="col-sm-7" style="padding-top: 7px">
                                        <a href="${pageContext.request.contextPath}/fileDownloadController_fileDownload.action?fileType=2&fileName=reader.xls">点击下载</a><br/>
                                    </div>
                                </div>
