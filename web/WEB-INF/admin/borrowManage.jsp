...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/admin/borrowmanager/getBorrowInfo.js"></script>
    <script src="${pageContext.request.contextPath}/static/js/admin/borrowmanager/borrowBook.js"></script>
</head>
                                    ...
                                    <div class="col-lg-5 form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="borrowBookISBN" name="borrowBookISBN"
                                                   type="text" value="111" placeholder="请输入借阅图书的ISBN号">
                                            <label class="control-label" style="display: none"></label>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <script type="text/javascript">
                        function page(pageCode) {
                            window.location.href = "${pageContext.request.contextPath}/admin/borrowManageController_list.action?pageCode=" + pageCode;
                        }
                    </script>
