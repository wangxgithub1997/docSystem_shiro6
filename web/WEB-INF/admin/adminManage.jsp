                ...
                <div class="col-lg-12">
                    ...
                    <script type="text/javascript">
                        function page(pageCode) {
                            window.location.href = "${pageContext.request.contextPath}/admin/adminManageController_list.action?pageCode=" + pageCode
                            +"&adminName=${query.adminName}&adminUserName=${query.adminUserName}";
                        }
                    </script>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" value="李四" id="addUsername" placeholder="请输入管理员用户名">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" value="李四四" id="addName" placeholder="请输入管理员真实姓名">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="addPhone" value="18511898645" placeholder="请输入管理员联系电话">
