                ...
                <div class="col-lg-12">
                    ...
                    <script type="text/javascript">
                        function page(pageCode) {
                            window.location.href = "${pageContext.request.contextPath}/admin/bookManageController_list.action?pageCode=" + pageCode+"&bookTypeId=${query.bookTypeId}&ISBN=${query.ISBN}&press=${query.press}&autho=${query.autho}&bookName=${query.bookName}";
                        }
                    </script>
                ...
                <form action="/admin/fileUploadController_fileUpload.action" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7" style="padding-top: 7px">
                            <a href="${pageContext.request.contextPath}/fileDownloadController_fileDownload.action?fileType=2&fileName=book.xls">点击下载</a><br/>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">图书名称</label>
                        <div class="col-sm-7">
                            <input type="text" value="名称" class="form-control" id="addBookName" placeholder="请输入图书名称">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">作者名称</label>
                        <div class="col-sm-7">
                            <input type="text" value="作者名称" class="form-control" id="addAutho" placeholder="请输入作者名称">
